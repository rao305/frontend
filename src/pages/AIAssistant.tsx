...
const AIAssistant: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-900 rounded-lg border border-gray-800">
      {/* Header */}
      <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-gray-900 p-8 rounded-t-lg">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-900 text-lg">Your intelligent academic advisor and course planning companion</p>
            <div className="flex items-center space-x-4 mt-2">
              <span className="bg-gray-900 bg-opacity-20 px-3 py-1 rounded-full text-sm font-medium">
                🎓 Academic Planning
              </span>
              <span className="bg-gray-900 bg-opacity-20 px-3 py-1 rounded-full text-sm font-medium">
            ...
            <div className="space-y-3">
              {examplePrompts.map((prompt, index) => (
                <button
                  ...
                  className="w-full text-left p-4 bg-gray-900 rounded-lg hover:bg-gray-700 hover:border-yellow-500/30 border border-gray-600 transition-all text-sm text-gray-300 hover:text-white shadow-sm hover:shadow-md"
                >
          ...
          <div className="border-t border-gray-700 bg-gray-900 p-6">
            <div className="flex space-x-4">
              <input
                ...
                className="flex-1 border border-gray-600 bg-gray-800 text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent placeholder-gray-400"
              />
              <button
                onClick={handleSendMessage}
                disabled={!inputText.trim()}
                className="bg-yellow-500 text-gray-900 px-6 py-3 rounded-lg hover:bg-yellow-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
              >
