    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Current Courses */}
          <div className="bg-subtle-grey border border-subtle-border p-6 rounded-sm">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-medium text-subtle-text">Current Courses</h2>
              <span className="text-xs font-medium text-subtle-secondary uppercase tracking-wide">Spring 2025</span>
            </div>
          ...
          {/* Progress Overview */}
          <div className="bg-subtle-grey border border-subtle-border p-8 rounded-sm">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-subtle-grey border border-subtle-border p-6 rounded-sm">
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-12 h-12 bg-subtle-grey border border-subtle-border flex items-center justify-center rounded-sm">
                <Bot className="w-6 h-6 text-subtle-text" />
              </div>
              <div>
                <h3 className="font-semibold text-subtle-text text-lg">Ask Boiler AI</h3>
                <p className="text-sm text-subtle-secondary">Get instant academic guidance</p>
              </div>
            </div>
            <div className="space-y-3">
              <button
                to="/ai-assistant"
                className="block w-full text-left p-4 bg-subtle-grey border border-subtle-border hover:bg-subtle-hover transition-all duration-200 text-sm text-subtle-text rounded-sm"
              >
          ...
          <div className="bg-subtle-grey border border-subtle-border p-6 rounded-sm">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4 p-4 bg-subtle-grey border border-subtle-border rounded-sm">
                <Clock className="w-5 h-5 text-subtle-text" />
                <div>
                  <p className="text-sm font-medium text-subtle-text">CS 25100 Project</p>
                  <p className="text-xs text-subtle-secondary">Due March 10</p>
                </div>
              </div>
              <div className="flex items-center space-x-4 p-4 bg-subtle-grey border border-subtle-border rounded-sm">
                ...
                <div>
                  ...
                  <p className="text-xs text-subtle-secondary">March 15</p>
                </div>
              </div>
              <div className="flex items-center space-x-4 p-4 bg-subtle-grey border border-subtle-border rounded-sm">
                ...
                <div>
                  ...
                  <p className="text-xs text-subtle-secondary">March 18</p>
                </div>
              </div>
            </div>
          </div>
