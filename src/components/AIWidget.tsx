        ...
        <div className="space-y-2">
          ...
          {quickQuestions.map((question, index) => (
            <button
              ...
              className="w-full text-left text-sm text-gray-300 p-2 rounded-lg bg-gray-700 hover:bg-gray-600 transition-colors shadow-sm"
            >
              {question}
            </button>
          ))}
        ...
        <div className="space-y-3">
          ...
          <div className="flex space-x-2">
            <input
              ...
              className="flex-1 text-sm border border-gray-600 bg-gray-700 text-gray-100 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-600"
            />
            <button className="bg-yellow-600 text-gray-800 p-2 rounded-lg hover:bg-yellow-700 transition-colors shadow-md">
